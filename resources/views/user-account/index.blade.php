			...
			<div class="row justify-content-center">
			  <div class="col-md-3">
			    <div class="nav flex-column nav-pills bg-white border rounded" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  ...
                  <a class="nav-link text-dark p-3" href="/logout"><i class="fa fa-power-off text-danger"></i> Log Out</a>
                  </form>
                            ...
                            <div id="no-data-row" class="card mb-3 nodata">						 
                                <div class="row no-gutters">						    					    
                                        ...
                                        <div class="card-header ">							  	
                                            ...
                                            <div  class="col text">
                                                <strong style="margin-left:230px;" >
                                            </strong>
                                            </div>							    
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <div class="col text-left align-self-center">
                                                <span class="text-decoration-none badge bg-success"><i class="fas fa-ban"></i></span>
                                            </div>
