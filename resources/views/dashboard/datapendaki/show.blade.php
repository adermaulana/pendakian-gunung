...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
            ...
            <a class="btn btn-success" href="/dashboard/datapendaki"><span data-feather="arrow-left"></span> Back To All My Posts</a>
            <a class="btn btn-warning" href="/dashboard/datapendaki/{{ $posts->slug }}/edit"><span data-feather="arrow-left"></span> Edit</a>
